...
export const FAMSFHero: React.FC = () => {
  return (
    <div className="relative min-h-screen overflow-hidden w-full max-w-full overflow-x-hidden">
      ...
      <div className="absolute top-4 left-4 md:top-4 md:left-8 z-20 max-w-[calc(100vw-2rem)]">
        <img 
          src={`${process.env.PUBLIC_URL}/assets/logo_lightgray.png`}
          alt="FAMSF Logo" 
          className="w-24 h-24 md:w-32 md:h-32 lg:w-36 lg:h-36 opacity-90 hover:opacity-100 transition-opacity duration-300"
        />
      </div>
      ...
      <div className="relative z-10 flex items-start md:items-center justify-center min-h-screen pt-4 md:pt-14 overflow-x-hidden w-full">
        <div className="container mx-auto px-4 md:px-6 text-center text-white w-full max-w-full overflow-x-hidden">
          ...
          <motion.h1 
            className="f-heading-8-serif mb-4 md:mb-6 text-white text-5xl md:text-8xl lg:text-9xl mt-28 md:mt-2 break-words"
          ...
          >
            ...
            <motion.div 
              ...
              whileTap={{ scale: 0.95 }}
            >
              <div className="bg-white/2 md:bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-3 md:p-6 hover:bg-white/20 transition-all duration-300">
          ...
          <motion.div 
            className="mt-8 md:mt-8 text-white/60"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
